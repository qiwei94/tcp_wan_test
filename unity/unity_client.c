...
int main(int argc, char const *argv[])
{
    ...
    char char_connect_interval[30];
    strncpy(char_connect_interval,argv[5],sizeof(argv[5]));
    int int_connect_interval=atoi(char_connect_interval);
...
void *fun_thrReceiveHandler(void *socketCon){
    ...
    while(1){
        ...
        //printf("服务器说：%s\n",buffer);
        printf("%d : %d : %d B\n",_socketCon,count,buffer_length);
    }
    printf("退出接受服务器数据线程\n");
    return NULL;
}
